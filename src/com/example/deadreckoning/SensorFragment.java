...
//*******************************************************************************************************************	
	...
	private void logData() {
		int steps = 0;
		String timestamp = "";
		if (MainActivity.getInstance().getLoggingStatus()){
			timestamp = FunctionHelper.getTimeDif();
		}
    	...
    	String line = timestamp + "," + oFused[0]+","+oFused[1]+","+oFused[2]+","
    			...
    			+orgGyro[0]+","+orgGyro[1]+","+orgGyro[2]
    					;
    	DataLogManager.addLine("datalog",line,false);
}
