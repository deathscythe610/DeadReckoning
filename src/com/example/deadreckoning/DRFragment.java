...
import com.example.deadreckoning.DeadReckoning.States;
...
public class DRFragment extends Fragment implements Runnable {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		ScrollView layout = (ScrollView)inflater.inflate(R.layout.dead_reckoning, container, false);
		if(layout==null) {
